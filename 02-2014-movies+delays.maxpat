...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 363.5, 136.5, 30.0, 19.0 ],
													"text" : "Esc"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 26.5, 194.5, 278.0, 20.0 ],
													"text" : "jit.window ein_window_namens_franz @noaccel 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "jit_matrix", "" ],
													"patching_rect" : [ 26.5, 119.5, 111.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"text" : "Direct to window playback: Effizenteste Methode Filme in bester Qualität abzuspielen, wenn keine weitere Prozessierung nötig ist"
												}
...
,
									"patching_rect" : [ 23.0, 148.0, 114.0, 22.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
, 			{
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-19::obj-4::obj-21" : [ "number", "number", 0 ],
			"obj-1::obj-19::obj-4::obj-20" : [ "live.tab[1]", "live.tab[1]", 0 ],
			"obj-1::obj-19::obj-4::obj-18" : [ "number[1]", "number[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "demovideo.maxpat",
